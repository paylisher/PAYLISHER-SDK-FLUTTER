...
=========
 ...
 2. Choose a tag name (e.g. `3.0.0`), this is the version number of the release.
    ...
    ```
 3. Go to [GH Releases](https://github.com/softmarketsolution/paylisher-FlutterSDK/releases)
 ...
 8. GH Action (publish.yml) is doing everything else [automatically](https://pub.dev/packages/paylisher_flutter/admin).
 9. Done.
