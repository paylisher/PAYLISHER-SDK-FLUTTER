...
import 'package:paylisher_flutter/src/replay/image_extension.dart';
import 'package:paylisher_flutter/src/replay/mask/image_mask_painter.dart';
import 'package:paylisher_flutter/src/replay/mask/paylisher_mask_controller.dart';
import 'package:paylisher_flutter/src/replay/native_communicator.dart';
import 'package:paylisher_flutter/src/replay/screenshot/snapshot_manager.dart';
import 'package:paylisher_flutter/src/replay/size_extension.dart';
import 'package:paylisher_flutter/src/replay/vendor/equality.dart';
...
class ScreenshotCapturer {
  ...
  Future<ImageInfo?> captureScreenshot() {
    final context =
        PaylisherMaskController.instance.containerKey.currentContext;
    if (context == null) {
    ...
    try {
      ...
      final paylisherWidgetWrapperElements =
          PaylisherMaskController.instance.getPaylisherWidgetWrapperElements();
      ...
      if (replayConfig.maskAllTexts || replayConfig.maskAllImages) {
        elementsDataWidgets =
            PaylisherMaskController.instance.getCurrentWidgetsElements();
      }

      /// we firstly get current image (syncImage) and masks
      /// (paylisherWidgetWrapperElements, elementsDataWidgets) synchronously and
      ...
      Future(() async {
        ...
        if (replayConfig.maskAllTexts || replayConfig.maskAllImages) {
          ...
          if (paylisherWidgetWrapperElements != null &&
              paylisherWidgetWrapperElements.isNotEmpty) {
            _imageMaskPainter.drawMaskedImageWrapper(
                canvas, paylisherWidgetWrapperElements, pixelRatio);
          }
