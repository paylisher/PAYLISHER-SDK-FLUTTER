...
abstract class PaylisherFlutterPlatformInterface extends PlatformInterface {
  ...
  PaylisherFlutterPlatformInterface() : super(token: _token);

  static final Object _token = Object();

  static PaylisherFlutterPlatformInterface _instance = PaylisherFlutterIO();

  /// The default instance of [PaylisherFlutterPlatformInterface] to use.
  ///
  /// Defaults to [PaylisherFlutterIO].
  static PaylisherFlutterPlatformInterface get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [PaylisherFlutterPlatformInterface] when
  /// they register themselves.
  static set instance(PaylisherFlutterPlatformInterface instance) {
