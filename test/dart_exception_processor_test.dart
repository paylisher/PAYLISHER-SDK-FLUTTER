...
import 'package:paylisher_flutter/src/error_tracking/dart_exception_processor.dart';
import 'package:paylisher_flutter/src/error_tracking/paylisher_exception.dart';
...
#0      Object.noSuchMethod (package:paylisher-flutter:1884:25)
...
''');
      ...
      final result = DartExceptionProcessor.processException(
        ...
        inAppIncludes: ['paylisher_flutter_example'],
        inAppExcludes: [],
        inAppByDefault: true,
      );
...
''');
    ...
    test('removes Paylisher frames when stack trace is generated', () {
      final exception = Exception('Test exception');

      // Create a mock stack trace that includes Paylisher frames
      final mockStackTrace = StackTrace.fromString('''
#0      DartExceptionProcessor.processException (package:paylisher_flutter/src/error_tracking/dart_exception_processor.dart:28:7)
#1      PaylisherFlutterIO.captureException (package:paylisher_flutter/src/paylisher_flutter_io.dart:435:29)
#2      Paylisher.captureException (package:paylisher_flutter/src/paylisher.dart:136:7)
#3      userFunction (package:my_app/main.dart:100:5)
#4      PaylisherFlutterIO.setup (package:paylisher_flutter/src/paylisher.dart:136:7)
...
''');
      ...
      expect(frames[1]['package'], 'paylisher_flutter');
      expect(frames[1]['filename'], 'paylisher.dart');
    ...
    test('processes PaylisherException with different mechanism types', () {
      final testCases = [
      ...
      for (final testCase in testCases) {
        ...
        final paylisherException = PaylisherException(
    ...
    test(
        'uses original error for stack trace processing when wrapped in PaylisherException',
        () {
    ...
    test('processes original error type correctly when wrapped', () {
      ...
      for (final originalError in testErrorTypes) {
        ...
        // Should extract type from original error, not PaylisherException
